...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="RUS" lang="en">
...
<tr>
	<td id="menu">
        ...
        <?if(empty($_SESSION ['username'])){?>  
            ...
            <div id="reg-links"><a href="index.php?view=signup"><?=lang('singup');?></a><a href="index.php?view=forgot"><?=lang('forgot');?></a></div>
        &nbsp;
        
        <?}
        else{?>
        
          <div class="lk">Приветствуем Вас, <b><?=$_SESSION['username'];?>, Ваш статус: <?=$_SESSION['status'];?></b>
